...
public record WeatherSmhi(ZonedDateTime approvedTime, ZonedDateTime referenceTime, Geometry geometry, List<TimeSerie> timeSeries) {
    public record TimeSerie(ZonedDateTime validTime, List<Parameter> parameters) { }
